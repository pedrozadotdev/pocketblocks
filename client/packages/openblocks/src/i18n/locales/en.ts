...
export const en = {
  ...
  branding: {
    ...
    brandNamePlaceholder: "Enter with the brand name",
    headColorTitle: "Head Color",
    headColorPlaceholder: "Enter with the Head Color",
    headColorHelp: "Color in #000000 format",
    hexColorCheck: "Please enter a valid RGB Color",
    save: "Save",
    saveSuccessMsg: "Saved successfully",
  ...
  profile: {
    ...
    bindingSuccess: "{sourceName} updated successfully",
    ...
    confirmNewEmail: "Confirm Email Change:",
  ...
  userAuth: {
    ...
    registerAdmin: "Create the first admin",
    email: "Email:",
    name: "Full Name:",
    inputValidName: "Please enter your full name",
    inputEmail: "Please enter your {label}",
    inputValidEmail: "Please enter a valid {label}",
    register: "Sign up",
    recoveryPassword: "Reset password",
    recoveryPasswordSendTitle: "Enter your email",
    recoveryPasswordSendBtn: "Reset password",
    recoveryPasswordChangeTitle: "Enter your new password",
    recoveryPasswordChangeBtn: "Confirm new password",
    userLogin: "Sign in",
    login: "Sign in",
    bind: "Bind",
  ...
  home: {
    ...
    resCardSubTitle: "Created {time}",
    resCardSubTitleTimeFormat: "at YYYY-MM-DD",
  ...
  idSource: {
    title: "Customize authentication methods",
    titleHelpStart: "Enable the authentication method in ",
    titleHelpEnd: " so it appears here.",
    loginType: "Login type",
    modalTitle: "Customize the authentication: ",
    local: "Local",
    customLabelLabel: "Label",
    customLabelPlaceholder: "Enter the label",
    inputMaskLabel: "Input mask",
    inputMaskPlaceholder: "Enter the input mask",
    useMaskInputLink: "Please, see user-mask-input docs",
    customIconUrlLabel: "Icon URL",
    customIconUrlPlaceholder: "Enter the icon URL",
    customIconUrlCheckMsg: "Please enter a valid URL",
    customIconUrlHelp: ".JPG, .SVG ou .PNG only",
    customNameLabel: "Custom name",
    customNamePlaceholder: "Enter the custom name",
